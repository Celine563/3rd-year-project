...
def home():
    ...
    if request.method == "POST":
        ...
        data["suspicious_patterns"] = pattern_info.get("suspicious_keywords", [])
        ...
        data["long_subdomain_chain"] = obfuscation.get("long_subdomain_chain", False)
        data["subdomain_count"] = obfuscation.get("subdomain_count", 0)

        data["suspicious_chars_obfus"] = obfuscation.get("suspicious_chars", [])
        data["path_redirection"] = obfuscation.get("path_redirection", False)
        ...
        # Blacklist checks
        blacklist_result = check_url_against_public_blacklists(normalised_url)
        ...
        if domain:
            try:
                ...
                data["domain_info"] = domain_results.get("domain_info", {})
                data["dns_records"] = domain_results.get("dns_records", {})
                data["infrastructure"] = domain_results.get("infrastructure", {})
                data["analysis_penalties"] = domain_results.get("analysis_penalties", {})
        ...
        score = score_url(
            ...
            long_subdomain_chain=data.get("long_subdomain_chain"),
            subdomain_count=data.get("subdomain_count"),
            suspicious_chars=data.get("suspicious_chars_obfus"),
            path_redirection=data.get("path_redirection"),
            reputation_risk=reputation_risk,
            blacklist_hits=blacklist_hits,
            misleading_brand_terms=data.get("misleading_brand_terms"),
        ...
        if score >= 85:
            ...
            data["risk_message"] = "This website contains suspicious indicators."

        else:
            data["risk_level"] = "malicious"
            data["risk_message"] = "This website is likely malicious."
